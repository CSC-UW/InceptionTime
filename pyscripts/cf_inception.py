...
sys.path.append('/home/leonardo.barbosa/projects/voltametry/InceptionTime/')
...
# jitter = None
jitter = 500
output_directory = f'/mnt/nfs/proj/in-vitro/Leonardo/inception/results/cf/J{jitter}/E{args.epochs}/{hold_probe}/'

if not (os.path.exists(output_directory)):
    os.makedirs(output_directory, exist_ok=True)

# val_probe=None
val_probe=probes[args.probe-1]
